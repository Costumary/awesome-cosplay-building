# Awesome Cosplay Building [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
- **Wig care:** Got2b Freeze Spray for spikes (the only thing that holds), a wide-tooth comb for detangling, and a wig head for storage. Never ball up a wig in a bag.
...
- [EL wire](https://www.adafruit.com/category/50) - Flexible glowing wire for Tron-style lines. Runs on batteries, easy to install. ~$8-15/roll.
...
- [Fabric.com](https://www.fabric.com) (now Amazon) - Decent selection, reasonable prices.
- [Spandex House](https://spandexhouse.com) - Spandex and stretch fabrics for bodysuits and undersuits.
- [Dharma Trading](https://www.dharmatrading.com) - Dyeable fabrics and dye supplies.
...
| Sewing machine | $100-250 | Bodysuits, tabards, capes, pouches. Even a basic machine handles cosplay fabric. |
...
- **Best starter printers:** Creality Ender-3 V3, Bambu Lab A1 Mini, AnyCubic Kobra 2.
...
- **File sources:** [Thingiverse](https://www.thingiverse.com), [MyMiniFactory](https://www.myminifactory.com), [Cults3D](https://cults3d.com), [Etsy](https://www.etsy.com) (paid files).
- **Scaling:** Measure the body part, scale the model in your slicer. Always do a test print at 10% scale first.
